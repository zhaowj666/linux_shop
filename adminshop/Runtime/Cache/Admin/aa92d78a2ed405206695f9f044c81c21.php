...
<head>
    ...
    <link href="http://www.adminshop.com/Public/Admin/treegrid/css/jquery.treegrid.css" rel="stylesheet" type="text/css" />

    
    <script type="text/javascript" src="http://www.adminshop.com/Public/Admin/treegrid/js/jquery.treegrid.js"></script>
            ...
            <td align="left" class='first-cell'><?php echo ($row["name"]); ?></td>
                ...
                <td><a class="ajax_get"
                       href="<?php echo U('changeStatus',array('id'=>$row['id'],'status'=>(1-$row['status'])));?>"><img
                        src="http://www.adminshop.com/Public/Admin/images/<?php echo ($row["status"]); ?>.gif"/></a></td>
                <td>
